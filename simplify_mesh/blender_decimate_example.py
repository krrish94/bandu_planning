...
def decimate_mesh(obj_name, reduction_factor, target_faces):
    """
    Decimate the mesh object iteratively by the reduction_factor until the number of faces is less than target_faces.
...
load_mesh("/home/krishna/code/bandu_planning/bandu_stacking/models/random_models/teddy.obj", "my_mesh")
decimate_mesh("my_mesh", 0.1, 50)
bpy.ops.export_scene.obj(filepath="/home/krishna/code/bandu_planning/bandu_stacking/models/random_models/teddy_decimated.obj")