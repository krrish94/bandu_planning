# -*- coding: utf-8 -*-
"""Robot class provide a common, higher-level interface to various robot
arms."""
...
class Robot(ABC):
    ...
    positions and Euler rotations.  This makes it easier to specify
    poses and coordinate frames using a more intuitive representation
    than quaternions.
    """
    ...
    def tcp(self):
        ...
        tool = (x, y, z, alpha, beta, gamma) x, y, z specify a Cartesian
        position (mm) alpha, beta, gamma specify an euler rotation
        (degrees)
        """
        pass
    ...
    def tcp(self, tcp):
        ...
        tcp = (x, y, z, alpha, beta, gamma) x, y, z specify a Cartesian
        position (mm) alpha, beta, gamma specify an euler rotation
        (degrees)
        """
        pass
    ...
    def coord_frame(self):
        ...
        frame = (x, y, z, alpha, beta, gamma) x, y, z specify a
        Cartesian position (mm) alpha, beta, gamma specify an euler
        rotation (degrees)
        """
        pass
    ...
    def joint_angles(self):
        ...
        specify the joint angles (degrees), numbered from base to end
        effector
        """
        pass
    ...
    def pose(self):
        ...
        pose = (x, y, z, alpha, beta, gamma) x, y, z specify a Cartesian
        position (mm) alpha, beta, gamma specify an euler rotation
        (degrees)
        """
        pass
    ...
    def move_linear(self, pose, elbow):
        ...
        pose = (x, y, z, alpha, beta, gamma) x, y, z specify a Cartesian
        position (mm) alpha, beta, gamma specify an euler rotation
        (degrees) elbow = target elbow angle for 7-DOF robot arm
        (optional; degrees)
        """
        pass
    ...
    def move_circular(self, via_pose, end_pose, elbow):
        ...
        via_pose, end_pose = (x, y, z, alpha, beta, gamma) x, y, z
        specify a Cartesian position (mm) alpha, beta, gamma specify an
        euler rotation (degrees) elbow = target elbow angle for 7-DOF
        robot arm (optional; degrees)
        """
        pass
...
class SyncRobot(Robot):
    ...
    def move_linear(self, pose, elbow=None):
        ...
        specified pose in the reference coordinate frame."""
        check_pose(pose)
        target_base_pose_q = inv_transform(
            euler2quat(pose, self._axes), self._coord_frame_q
        )
    ...
    def move_circular(self, via_pose, end_pose, elbow=None):
        ...
        check_pose(via_pose)
        check_pose(end_pose)
        via_base_pose_q = inv_transform(
            euler2quat(via_pose, self._axes), self._coord_frame_q
        )
        target_base_pose_q = inv_transform(
            euler2quat(end_pose, self._axes), self._coord_frame_q
        )
...
class AsyncRobot(Robot):
    ...
    def async_move_joints(self, joint_angles):
        ...
        self._busy = True
        self._worker = Thread(
            target=lambda joint_angles, results: results.put(
                self.sync_robot.move_joints(joint_angles)
            ),
    ...
    def async_move_linear(self, pose, elbow=None):
        ...
        pose = (x, y, z, alpha, beta, gamma) x, y, z specify a Cartesian
        position (mm) alpha, beta, gamma specify an euler rotation
        (degrees) elbow = target elbow angle for 7-DOF robot arms
        (optional; degrees)
        """
        if self._busy:
            raise AsyncBusy
        self._busy = True
        self._worker = Thread(
            target=lambda pose, elbow, results: results.put(
                self.sync_robot.move_linear(pose, elbow)
            ),
    ...
    def async_move_circular(self, via_pose, end_pose, elbow=None):
        ...
        specify a Cartesian position (mm) alpha, beta, gamma specify an
        euler rotation (degrees) elbow = target elbow angle for 7-DOF
        robot arms (optional; degrees)
        """
        if self._busy:
            raise AsyncBusy
        self._busy = True
        self._worker = Thread(
            target=lambda via_pose, end_pose, elbow, results: results.put(
                self.sync_robot.move_circular(via_pose, end_pose, elbow)
            ),
