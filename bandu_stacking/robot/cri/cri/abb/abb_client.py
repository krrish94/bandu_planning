...
Adapted from Open ABB python client (
...
class ABBClient:
    ...
    def move_linear(self, pose):
        ...
        position (default mm) qw, qx, qy, qz specify a quaternion
        rotation
        """
    ...
    def move_circular(self, via_pose, end_pose):
        ...
        Cartesian position (default mm) qw, qx, qy, qz specify a
        quaternion rotation
        """
    ...
    def set_work_object(self, work_object):
        ...
        work_object = (x, y, z, qw, qx, qy, qz) x, y, z specify a
        Cartesian position (default mm) qw, qx, qy, qz specify a
        quaternion rotation
        """
    ...
    def set_speed(self, linear_speed, angular_speed):
        """Sets the linear speed (default mm/s) and angular speed (default
        deg/s) of the robot TCP."""
    ...
    def set_zone(self, zone_key="z0", point_motion=False, manual_zone=None):
        zone_dict = {
            "z0": (0.3, 0.3, 0.03),
            "z1": (1, 1, 0.1),
            "z5": (5, 8, 0.8),
        ...
        the flyby zone, AKA if the robot is going from point A -> B -> C, how
        close do we have to pass by B to get to C.
