...
import bandu_stacking.robot.cri.cri.ur.rtde.rtde_config as rtde_config
import bandu_stacking.robot.cri.cri.ur.rtde.rtde_proxy as rtde_proxy
...
class RTDEClient:
    ...
    def connect(self, ip, port):
        ...
        params_vec_6d_2_names, params_vec_6d_2_types = conf.get_recipe(
            "params_vec_6d_2"
        )
        ...
        self._params_vec_6d = self._con.send_input_setup(
            params_vec_6d_names, params_vec_6d_types
        )
        self._params_vec_6d_2 = self._con.send_input_setup(
            params_vec_6d_2_names, params_vec_6d_2_types
        )
        self._params_1d = self._con.send_input_setup(params_1d_names, params_1d_types)
        self._params_1d_2 = self._con.send_input_setup(
            params_1d_2_names, params_1d_2_types
        )
    ...
    def move_linear(self, pose):
        ...
        pose = (x, y, z, ax, ay, az) x, y, z specify a Cartesian
        position (mm) ax, ay, az specify an axis-angle rotation (rad)
        """
    ...
    def move_circular(self, via_pose, end_pose):
        ...
        via_pose, end_pose = (x, y, z, ax, ay, az) x, y, z specify a
        Cartesian position (mm) ax, ay, az specify an axis-angle
        rotation (rad)
        """
    ...
    def move_joint_speed(self, joint_speeds, joint_accel, return_time=None):
        ...
        return after that time, regardless of the target speed has been
        reached. If the return time is not provided, the function will return
    ...
    def move_linear_speed(self, linear_speed, linear_accel, return_time=None):
        """Accelerate linearly in Cartesian space and continue with constant
        tool speed. The return time is optional; if provided the function will
        return after that time, regardless of the target speed has been
        reached. If the return time is not provided, the function will return
        when the target speed is reached.
    ...
    def set_tcp(self, tcp):
        ...
        tcp = (x, y, z, ax, ay, az) x, y, z specify a Cartesian position
        (mm) ax, ay, az specify an axis-angle rotation
        """
    ...
    def get_pose(self):
        ...
        pose = (x, y, z, ax, ay, az) x, y, z specify a Cartesian
        position (mm) ax, ay, az specify an axis-angle rotation
        """
        self._state = self._con.receive()
    ...
    def get_linear_speed(self):
        ...
        linear speed = (xd, yd, zd, axd, ayd, azd) xd, yd, zd specify a
        translational velocity (mm/s) axd, ayd, azd specify an axis-
        angle rotational velocity (deg/s)
        """
        self._state = self._con.receive()
    ...
    def get_info(self):
        ...
        return "UR5 (controller version = {})".format(
