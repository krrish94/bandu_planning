...
def main():
    ...
    with AsyncRobot(SyncRobot(PyfrankaController(ip='192.168.1.11'))) as robot:
        ...
        robot.sync_robot.controller.rel_velocity = 0.2
        ...
        robot.move_linear(robot.pose + (0, 0, 0, 0, 0, 0))
        ...
        # robot.move_joints(robot.joint_angles + (20,)*7)
        ...
        # robot.move_linear((10, 0, 0, 0, 0, 0))
