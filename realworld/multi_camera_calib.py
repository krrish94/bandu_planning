...
def capture_realsense_image(output_folder, serial_number):
    ...
    from realsense_recorder import realsense_capture, get_profiles, Preset
...
def main():
    ...
    result_icp_cam_2_to_1 = o3d.pipelines.registration.registration_icp(pcd2, pcd1, 0.03, np.eye(4), o3d.pipelines.registration.TransformationEstimationPointToPlane())
    result_icp_cam_3_to_1 = o3d.pipelines.registration.registration_icp(pcd3, pcd1, 0.03, np.eye(4), o3d.pipelines.registration.TransformationEstimationPointToPlane())
