...
try:
    ...
    print("pyrealsense2 not found. Live capture will not work.")
...
def main():
    ...
    # # Crop box from the merged point cloud
    # bbox = o3d.geometry.AxisAlignedBoundingBox(
    #     min_bound=(-1.5, -1.5, -1.5), max_bound=(1.5, 1.5, 1.5)
    # )
    # cropped_pcd = pcd1.crop(bbox)
